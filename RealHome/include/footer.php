                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom" src="images/logo/log1.jpg" style="height: 80px"  class="rounded-pill" alt="image"></a> </div>
                                        <p class="pb-20 text-white">RealHome offers affordable, luxuries housing across kenya major cities.</p>
										<p class="pb-20 text-white">Nyumba bora maisha bora</p>
                                        </div>
                                </div>
...
<!--                                                    <li><a href="#" class="text-white">Our Agents</a></li>-->
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Mfangano Street, Ronald Ngala Plaza, Nairobi</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>0790447137</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>0790447137</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>clintonmikida@gmail.com.com</li>
                                                </ul>
<!--                                            </div>-->
...
<!--                                        </div>-->
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© 2022 RealHome  All right reserved</span> </div>
                    <div class="col-sm-6">
