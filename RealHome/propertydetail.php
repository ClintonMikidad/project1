...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner   --->
        <div class="banner-full-row page-banner" style="background-image:url('images/slide4.jpg');background-size: cover;height: 500px; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="property-details">
                            <div class="bg-gray property-quantity px-4 pt-4 w-100">
                                <ul>
                                    <li><span class="text-secondary"><?php echo $row['12'];?></span> M<sup>2</sup></li>
                                    ...
                                    <li><span class="text-secondary"><?php echo $row['10'];?></span> sitting room</li>
