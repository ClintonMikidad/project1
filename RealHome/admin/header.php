  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="dashboard.php" class="logo">
						<img src="assets/img/log2.png" alt="Logo"width="100" height="50"><h1>RealHome</h1>
					</a>
                    <h1>RealHome</h1>
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown app-dropdown">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
							<span class="user-img"><img class="rounded-circle" src="assets/img/profiles/team-5.jpg" width="31" alt="Ryan Taylor"></span>
						</a>
						
						<div class="dropdown-menu">
							<div class="user-header">
								<div class="avatar avatar-sm">
									<img src="assets/img/profiles/team-5.jpg" alt="User Image" class="avatar-img rounded-circle">
								</div>
								<div class="user-text">
